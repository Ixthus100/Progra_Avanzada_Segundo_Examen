...
namespace Ulatina.PrograAvanzada.AdventureWorks
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            decimal elPrecioSuperior = (decimal)21.8;
            var laAccion = new AW.Wcf.Acciones.Productos();
            var products = laAccion.EncontrarProductoPorRangoDePrecio(elPrecioInferior, elPrecioSuperior);
            return View(products.ToList());
        }

        // GET: Products/Details/5 EDITADO
        public ActionResult MisDetallesPorProductNumber(string productNumber)
        {
            ...
            var laAccion = new AW.Wcf.Acciones.Productos();
            var product = laAccion.EncontrarProductoPorNumero(productNumber);
            if (product == null)
            {
                return HttpNotFound();
            }
